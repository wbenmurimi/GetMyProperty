  ...
  <div class="row">
    <div class="">
       ...
       <li>
        ...
        <i class="fa fa-plus-square prefix"></i>Property Features</div>
          ...
          <div class=" space_dropdown_d input-field col s3 l3">
            <input name="" id="24hr_radio" type="checkbox" class=" with-gap filled-in" >
            <label for="24hr_radio">24Hr security</label>
          </div>
          <div class=" space_dropdown_d input-field col l3 s3">
            <input name="" id="cctv_radio" type="checkbox" class=" with-gap filled-in" >
            <label for="cctv_radio">CCTV</label>
          </div>
          <div class=" space_dropdown_d input-field col s3 l3">
            <input name="" id="alarm_radio" type="checkbox" class=" with-gap filled-in" >
            <label for="alarm_radio">Alarm System</label>
          </div>
          <div class=" space_dropdown_d input-field col l3 s3">
            <input name="" id="electric_radio" type="checkbox" class=" with-gap filled-in" >
            <label for="electric_radio">Electric Fence</label>
          </div>
          <div class="  input-field col l3 s3">
            <input name="" id="wall_radio" type="checkbox" class=" with-gap filled-in" >
            <label for="wall_radio">Wall</label>
          </div>    
          <div class="  input-field col s3 l3">
            <input name="" id="internet_radio" type="checkbox" class=" with-gap filled-in" >
            <label for="internet_radio">Internet Access</label>
          </div>
          <div class="  input-field col l3 s3">
            <input name="" id="pool_radio" type="checkbox" class=" with-gap filled-in" >
            <label for="pool_radio">Swimming Pool</label>
          </div>
          <div class="  input-field col s3 l3">
            <input name="" id="garden_radio" type="checkbox" class=" with-gap filled-in" >
            <label for="garden_radio">Garden</label>
          </div>
          <div class="  input-field col l3 s3">
            <input name="" id="water_radio" type="checkbox" class=" with-gap filled-in" >
            <label for="water_radio">Water storage</label>
          </div>
          <div class="  input-field col l3 s3">
            <input name="" id="gym_radio" type="checkbox" class=" with-gap filled-in" >
      ...
      <li>
       ...
       <div class=" space_dropdown_d input-field col s3 l3">
        <input name="p_cat" id="house_radio" type="radio" class=" with-gap" >
        <label for="house_radio">House</label>
      </div>
      <div class=" space_dropdown_d input-field col l3 s3">
        <input name="p_cat" id="land_radio" type="radio" class=" with-gap" >
  ...
  <div class="collapsible-body">
    ...
    <div class="row">
      <div class="col s12">
        ...
        Location:<br>
        <div class="input-field col l6 s12">
          <input id="longitude" type="text" class="validate" value="<?php echo $val;?>">
          <!-- <label for="longitude">Longitude</label>  -->
        </div>
        <div class="input-field col l6 s12">
         <input id="latitude" type="text" class="validate" value="<?php echo $val;?>">
