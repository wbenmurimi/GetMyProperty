...
<body onload="freePlan();uploadPageSession()">
 ...
 <div class="mybreadcrumb col s12 l12">
  <div class="breadcrumb flat ">
    ...
    <a href="free-plan.php" class="active">Featured plan</a>
  </div>
</div>
...
<div class="template-container">
  <div class="row">
    <div class="card">
      <h4 class="center">Upload property pictures (Max: 6)</h4>
      <div class=" center limit_error" id="limit_error" style="color: red; font-weight: bold;">
        
      </div>
      <div class="col l12 s12 card center">

        <form action="../model/featured-upload.php" method="POST" enctype="multipart/form-data" multiple="true">
      ...
      <div class="input-field col l3 s6">
       ...
       <div class="input-field col l3 s6">
        ...
        <div id="delete6"></div>  
         ...
         <div class="input-field col l3 s6">
        <div class="picture_preview" id="picture7">
        <div id="delete7"></div>  
...
<!--   <div class="input-field col l12 s12">
 ...
 <div class="loginfooter right">
   <a href="featured-post-review.php"> <button  type="submit" class="btn btnNext btnColor btn-spacer waves-effect wave-dark blue darken-1 center-align">Next</button>
   </a>
 </div>
</div>
</div>
