...
class Alerts extends base{
    ...
    function setAnAlert($phone, $email,$property_type,$property_category,
     $county, $sub_county, $buyrent, $price_from, $price_to,$bedroom,$bathroom,$endtime)
    {
      $str_query = "INSERT INTO xx_property_alerts(xx_phone, xx_email,xx_property_type,
        xx_property_category,xx_county,xx_sub_county, xx_buy_rent, xx_price_from, 
        xx_price_to , xx_bedroom,xx_bathroom, xx_end_time) 
    VALUES('$phone','$email','$property_type','$property_category','$county','$sub_county','$buyrent',
      '$price_from','$price_to','$bedroom','bathroom','$endtime')";
