...
<div class="template-container">
  <div class="col l12 s12 top-search">
    <div class="row">
      <div class="">
        <ul class="tabs text-color color ">
          <li class="tab col l4"><a class="active text-color"  href="#residential">Residential</a></li>
          <li class="tab col l4 text-color"><a class="text-color" href="#commercial">Commercial</a></li>
          <li class="tab col l4"><a class="text-color" href="#land">Land</a></li>
        </ul>
      ...
      <div class="input-field col l3 s12" id="selectDiv">
        ...
        <div id="commercial" class="col s12 ">
          <div class="input-field col s2 l2">
            ...
            <label for="commercial_buy_radio">Sale</label>
          </div>
          <div class="input-field col l2 s2">
      ...
      <div class="input-field col l3 s12" id="selectDiv">
        ...
        <div id="land" class="col s12 ">
         ...
         <div class="input-field col s2 l2">
          ...
          <label for="land_buy_radio">Sale</label>
        </div>
        <div class="input-field col l2 s2">
