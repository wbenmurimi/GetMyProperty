  ...
  <div class="row">
    <div class="col m4 s12 card ">
      ...
      <ol class="center btn-spacer statsOl">
       <a href="../my property/index.php"> <li class="myStats black-text">Total ads : <span class="stats" id="total_adds"> </span> </li></a>
       <br>
       <hr>
       <br>
       <a href="../alert/unsubscribe-alert.php"><li class="myStats black-text">Total alerts : <span class="stats" id="total_alerts"></span></li></a>
     </ol>
   </div>
   <div class="col m8 s12 card">
    ...
    <div class="row">
      <div class="col l12">
        <div class=" white">
          <ul class="tabs color">
          <li class="tab col s3"><a class="active" class="white-text" href="#signup">Acount Details</a></li>
            <li class="tab col s3"><a   href="#login" class="white-text">Change Password</a></li>
          </ul>
